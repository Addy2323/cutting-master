    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
        <div class="container">
            <a class="navbar-brand" href="{{ url('/') }}">
                {{ config('app.name', 'Appointment Booking') }}
            </a>
    ...
    <footer class="bg-dark text-white py-4 mt-5">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <h5>About Us</h5>
                    <p>We provide professional services with a focus on customer satisfaction and quality.</p>
                </div>
                <div class="col-md-4">
                    <h5>Quick Links</h5>
            ...
            <div class="text-center">
                <p class="mb-0">&copy; {{ date('Y') }} <strong>ADDO.NET</strong>. All rights reserved. Unauthorized duplication or publication of any materials from this site is expressly prohibited.</p>
                <p class="text-sm text-gray-400 mt-1">Empowering Digital Solutions</p>
            </div>
        </div>
    </footer>
